...
public class HbaseStorageConnector extends StorageConnector {
    ...
    public void scan(String nameSpace, String tableName, String family, String qualifier, String delimiter, FilterList filterList, Map<Integer,Integer> indexMap, String dayNumValue, OperatorBuffer<RawRow> buffer) throws StorageException {
