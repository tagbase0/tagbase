...
public class HbaseStorageConnector extends StorageConnector {
    ...
    public void scan(String nameSpace, String tableName, String family, String qualifier, String delimiter, boolean equalComparatorFlag, List<String> rowkeyPrefixList, Map<Integer,Integer> indexMap, String dayNumValue, OperatorBuffer<AggregateRow> buffer) throws StorageException {
